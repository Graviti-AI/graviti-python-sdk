...
from typing import TYPE_CHECKING, Any, Optional, Sequence, Type, TypeVar, Union, overload
...
if TYPE_CHECKING:
    ...
    _N = TypeVar("_N", bound=NBitBase)

_T = TypeVar("_T", bound=np.generic, covariant=True)


@register_extension_dtype
class GravitiDtype(ExtensionDtype):
...
class GravitiObject:
    ...
    def __init__(self, values: "NDArray[_T]") -> None:
        pass
...
class GravitiSeries(ExtensionArray, ExtensionScalarOpsMixin):
    ...
    @overload
    def __getitem__(self, item: Union[int, "np.integer[_N]"]) -> Any:
        ...

    @overload
    def __getitem__(self, item: Union[slice, Sequence[int], "NDArray[_T]"]) -> "GravitiSeries":
        ...

    def __getitem__(
        self, item: Union[int, "np.integer[_N]", slice, Sequence[int], "NDArray[_T]"]
    ) -> Union["GravitiSeries", Any]:
    ...
    def __setitem__(self, key: Union[int, slice, "NDArray[_T]"], value: Any) -> None:
    ...
    def _from_sequence(  # pylint: disable=arguments-differ
        cls, scalars: Sequence[Any], *, dtype: Optional[GravitiDtype] = None, copy: bool = False
    ) -> "GravitiSeries":
        ...
        Arguments:
            ...
            dtype: Construct for this particular dtype.
    ...
    @classmethod
    def _from_factorized(cls, values: "NDArray[_T]", original: "GravitiSeries") -> Any:
